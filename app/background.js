...
const dataPath = path__WEBPACK_IMPORTED_MODULE_1___default().join(electron__WEBPACK_IMPORTED_MODULE_2__.app.getPath('userData'), 'notes.json');
console.log('Data Path:', dataPath);

// Ensure that the notes.json file exists
if (!fs__WEBPACK_IMPORTED_MODULE_5___default().existsSync(dataPath)) {
  fs__WEBPACK_IMPORTED_MODULE_5___default().writeFileSync(dataPath, '[]', 'utf-8');
}
...
electron__WEBPACK_IMPORTED_MODULE_2__.ipcMain.handle('get-notes', async () => {
  try {
    const data = fs__WEBPACK_IMPORTED_MODULE_5___default().readFileSync(dataPath, 'utf-8');
...
electron__WEBPACK_IMPORTED_MODULE_2__.ipcMain.handle('save-notes', async (_event, notes) => {
  try {
    // Save the notes to the notes.json file
    fs__WEBPACK_IMPORTED_MODULE_5___default().writeFileSync(dataPath, _babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(notes, null, 2));
